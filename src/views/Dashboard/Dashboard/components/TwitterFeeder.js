...
function TwitterFeeder() {
  const [twitterId, setTwitterId] = useState(localStorage.getItem('twitterId') ? localStorage.getItem('twitterId') : '');
        ...
        <ModalContent>
          ...
          <ModalBody pb={6}>
            ...
            <InputGroup>
              ...
              <Input value={newTwitterId} onChange={onChange} placeholder='elonmusk' />
            </InputGroup>
          </ModalBody>
